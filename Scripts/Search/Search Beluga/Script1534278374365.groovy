...
Mobile.tap(findTestObject('Login/android.view.ViewGroup6'), 0)

Mobile.tap(findTestObject('Login/android.widget.ImageView0'), 0)

Mobile.tapAndHold(findTestObject('Login/android.view.ViewGroup6'), 0, 0)
